        ...
        <section className='flex flex-col gap-y-[50px]' aria-labelledby="contact-heading">
            ...
            <section className='education flex flex-col w-full p-[30px] border-[2px] border-black rounded-[50px] border-b-[20px] max-md:p-[15px]' aria-labelledby="say-hello-heading">
                <div className='relative mb-[50px]'>
                    ...
                    <img className='absolute top-[-40px] right-[-30px] h-[130px] max-lg:h-[80px]' src={pinlogo} alt="Pin icon beside heading" />
                </div>
                <div className='flex gap-x-[20px] justify-between items-center max-md:flex-col-reverse max-md:gap-y-[50px]'>
                    <div className='w-[600px] max-lg:w-[400px] max-md:w-full'>
                        <form onSubmit={handleSubmit} className='flex flex-col gap-y-[20px]' aria-label="Contact form">
                            ...
                            <button 
                                type='submit' 
                                className='cursor-pointer koulen-font text-[25px] border-t-[2px] border-l-[2px] bg-[#D9D981] border-r-[2px] border-b-[10px] rounded-[18px] py-[15px] px-[30px] max-lg:py-[8px] max-lg:px-[15px] max-lg:border-b-[8px] max-md:text-[20px] max-md:border-b-[5px] max-md:border-l-[1px] max-md:border-t-[1px] max-md:border-r-[1px] max-sm:text-[20px] max-sm:rounded-[10px]'
                            >
                                send
                            </button>
                        </form>
