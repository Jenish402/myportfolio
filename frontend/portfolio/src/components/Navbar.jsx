...
import jenishlogo from '../assets/JENISH.svg'
    ...
    <nav className='z-[100] sticky top-0 w-[350px] h-screen flex flex-col items-center p-[20px] max-md:w-screen max-sm:h-[155px] max-md:h-[210px] max-md:pt-[20px] max-md:pb-[150px] max-sm:pb-[0px] max-lg:w-[220px] max-sm:pt-[35px]'>
      <div className='flex flex-col items-center w-full max-lg:items-start'>
        <div className='pt-[50px] mb-[50px] flex items-center w-full max-md:mb-[10px] max-lg:pt-[20px] max-lg:justify-between max-md:pt-[0px] max-2xl:mb-[20px]'>
          <img className='h-[60px] w-auto max-lg:h-[50px] max-sm:h-[35px]' loading='lazy' src={jenishlogo} alt="JENISH" />
        ...
        <img className='h-full w-full mb-[30px] max-md:hidden max-2xl:mb-[25px]' loading='lazy' src={line} alt="" />
        ...
        <div className='w-full flex flex-col items-center justify-between max-md:flex-row'>
          <div className='flex items-center justify-center gap-x-[30px] mb-[30px] max-md:mb-[0] max-lg:gap-x-[20px] max-md:gap-x-[10px] max-2xl:mb-[25px]'>
            <a href="mailto:iamjenishsoni402@gmail.com"><img className='h-[50px] w-auto object-contain max-lg:h-[35px] max-md:h-[28px]' loading='lazy' src={mail} alt="" /></a>
            <a href="https://www.instagram.com/0001jenish_soni1000?igsh=MTdpYnZwanh0Nzl5ag=="><img className='h-[50px] w-auto object-contain max-lg:h-[35px] max-md:h-[28px]' loading='lazy' src={instagram} alt="" /></a>
            <a href="https://github.com/Jenish402"><img className='h-[50px] w-auto object-contain max-lg:h-[35px] max-md:h-[28px]' loading='lazy' src={github} alt="" /></a>
            <a href="https://www.linkedin.com/in/jenish-soni-a14174224?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><img className='h-[50px] w-auto object-contain max-lg:h-[35px] max-md:h-[28px]' loading='lazy' src={linkedin} alt="" /></a>
          </div>

          <img className='h-full w-full mb-[30px] max-md:hidden' loading='lazy' src={line} alt="" />
