...
//             </header>
//             <section className='relative flex flex-col gap-y-[30px] w-full' aria-labelledby="ai-ml-projects-title">
...
//                         <Box handleClick={closePopup} closeicon={<IoMdCloseCircle />} />
//                     </motion.div>
//                 )}
...
//                                 <IoIosArrowDropright onClick={openPopup} className='text-[30px] cursor-pointer hover:text-red-800' />
...
import awsphoto from '../assets/awsphoto.png'
import astraphoto from '../assets/astraphoto.png'
import grocerygo from '../assets/grocerygo.png'
import { IoIosArrowDropright } from "react-icons/io";
import Box from '../components/Box'
import { IoMdCloseCircle } from "react-icons/io";
