                    ...
                    <div className='flex '>
                        <form onSubmit={handleSubmit} className='flex'>
                            <input
                                ...
                                required
                                className='outline-none AD-font w-[500px] bg-transperent border-[2px] border-black text-[20px] p-[10px] rounded-tl-[15px] rounded-bl-[15px] max-lg:w-[350px] max-sm:w-[180px]' type="email" placeholder='E-mail' aria-label="Email address" />
